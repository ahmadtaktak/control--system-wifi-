    ...
    <div class="container">
        ...
        <form action="actions/a_create_course.php" method="POST">
            <div class="form-group">
                <input placeholder="Course name" class="form-control" type="text" name="course_name">
            </div>
            <div class="form-group">
                <input placeholder="Course year" class="form-control" type="number" min="2010" max="2099" step="1" name="course_year">
            </div>
            <div class="form-group">
            ...
            <input class="btn btn-primary fullBtn" type="submit" value="Create course">
        </form>
    </div>
</body>
</html>