<?php 
    ...
    if($_POST){
        ...
        $Cyear = $_POST["course_year"];
        $teacher = $_POST["teacher"];
        $obj->insert("courses", array("name","course_year","teacher"), array($Cname,$Cyear,$teacher));
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="alert alert-success text-center" role="alert">
        <h3>Created Successfuly</h3>
        <a class="btn btn-danger" href="../teachers-dashboard.php">Back to Home page</a>
    </div>
